...
#SBATCH --job-name "alexnet-64ranks-64nodes-batch256"
#SBATCH -o stdout.alexnet.64ranks.64nodes.batch256.txt
#SBATCH -e stderr.alexnet.64ranks.64nodes.batch256.txt
#SBATCH -p all
mpiexec \
