...
#SBATCH --job-name "alexnet-quicksolver-16ranks-4nodes-blocking-batch256"
#SBATCH -o stdout.alexnet.quicksolver.16ranks.4nodes.blocking.batch256.txt
#SBATCH -e stderr.alexnet.quicksolver.16ranks.4nodes.blocking.batch256.txt
#SBATCH -p all
mpiexec \
