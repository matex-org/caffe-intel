#ifndef CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_CPU12_HPP_
#define CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_CPU12_HPP_
...
class MPIGossipParamsCPU12 : public CPUParams<Dtype>, public Solver<Dtype>::Callback {
 public:
  explicit MPIGossipParamsCPU12(shared_ptr<Solver<Dtype> > root_solver,
          const SolverParameter& param, bool cube, bool rotate);
  virtual ~MPIGossipParamsCPU12();
