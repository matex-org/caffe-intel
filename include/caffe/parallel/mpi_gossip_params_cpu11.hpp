#ifndef CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_CPU11_HPP_
#define CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_CPU11_HPP_
...
class MPIGossipParamsCPU11 : public CPUParams<Dtype>, public Solver<Dtype>::Callback {
 public:
  explicit MPIGossipParamsCPU11(shared_ptr<Solver<Dtype> > root_solver,
          const SolverParameter& param, bool cube, bool rotate);
  virtual ~MPIGossipParamsCPU11();
