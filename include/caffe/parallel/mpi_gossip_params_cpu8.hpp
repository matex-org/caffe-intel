#ifndef CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_CPU8_HPP_
#define CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_CPU8_HPP_
...
class MPIGossipParamsCPU8 : public CPUParams<Dtype>, public Solver<Dtype>::Callback {
 public:
  explicit MPIGossipParamsCPU8(shared_ptr<Solver<Dtype> > root_solver,
          const SolverParameter& param, bool cube, bool rotate);
  virtual ~MPIGossipParamsCPU8();
