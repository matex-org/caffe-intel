#ifndef CAFFE_PARALLEL_GA_SYNC_CPU3_HPP_
#define CAFFE_PARALLEL_GA_SYNC_CPU3_HPP_
...
class GASyncCPU3 : public Solver<Dtype>::Callback {
 public:
  explicit GASyncCPU3(shared_ptr<Solver<Dtype> > root_solver);
  virtual ~GASyncCPU3();
