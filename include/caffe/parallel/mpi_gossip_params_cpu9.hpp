#ifndef CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_CPU9_HPP_
#define CAFFE_PARALLEL_MPI_GOSSIP_PARAMS_CPU9_HPP_
...
class MPIGossipParamsCPU9 : public CPUParams<Dtype>, public Solver<Dtype>::Callback {
 public:
  explicit MPIGossipParamsCPU9(shared_ptr<Solver<Dtype> > root_solver,
          const SolverParameter& param, bool cube, bool rotate);
  virtual ~MPIGossipParamsCPU9();
