#ifndef CAFFE_PARALLEL_MPI_LAYERWISE_ASYNC_ROTATE_CPU_HPP_
#define CAFFE_PARALLEL_MPI_LAYERWISE_ASYNC_ROTATE_CPU_HPP_
...
class MPI_layerwise_async_rotate_CPU : public CPUParams<Dtype>, public Solver<Dtype>::Callback {
 protected:
//#ifdef USE_MPI
   MPI_Comm comm_;
...
// #endif
  ...
  explicit MPI_layerwise_async_rotate_CPU (shared_ptr<Solver<Dtype> > root_solver,
  ...
  virtual ~MPI_layerwise_async_rotate_CPU();
